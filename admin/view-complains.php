...
if(isset($_GET['reject'])){
    $sql = "UPDATE complain SET status=2 WHERE id='{$_GET['reject']}'";
    if($conn->query($sql)){
        echo "<script>alert('Complain Rejected!'); window.location = './view-complains.php';</script>";
    } else {
        echo "<script>alert('Complain Rejection Failed!'); window.location = './view-complains.php';</script>";
    }
}
...
<body>
    <div class="main">
        ...
        <div class="main-content">
            ...
            <center><h2>View New Complains</h2></center>
            ...
            ?>
                    ...
                    <td>
                    <a href="./complain.php?id=<?php echo $row['id']; ?>"><i style="color:green;" class="fa fa-edit"></i></a> &nbsp;
                    <a href="./view-complains.php?reject=<?php echo $row['id']; ?>"><i style="color:red;" class="fa fa-close"></i></a>
                    </td>
                    </tr>
            <?php
                }
